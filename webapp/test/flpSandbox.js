		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Training",
									"targetURL": "#uiMyFirstProjecttrainingproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uiMyFirstProjecttrainingproject-display": {
								"semanticObject": "uiMyFirstProjecttrainingproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.MyFirstProject.trainingproject",
									"url": sap.ui.require.toUrl("ui/MyFirstProject/trainingproject")
								}
							}
						}
					}
